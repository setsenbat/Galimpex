  ...
  <div class="font-sans text-brand-text">
    ...
    <footer class="border-t border-gray-200 py-12" style="background-color: #EEEFF1;">
      <div class="max-w-7xl mx-auto px-4 md:px-6">
        <div class="grid grid-cols-2 md:grid-cols-6 gap-6 md:gap-8 mb-10">
          <!-- Brand -->
          ...
          <!-- Contact -->
          <div>
            <div class="font-semibold text-brand-text text-sm mb-3">{{ $t('landing.footer.contactCol.title') }}</div>
            <ul class="space-y-2 text-xs text-gray-500">
              <li><a href="/contact" class="hover:text-brand-text transition-colors">{{ $t('landing.footer.contactCol.contactPage') }}</a></li>
              <li><a href="mailto:sales@galimpex.mn" class="hover:text-brand-text transition-colors">sales@galimpex.mn</a></li>
              <li><a href="tel:11463614" class="hover:text-brand-text transition-colors">{{ $t('landing.footer.contactCol.phone') }}</a></li>
            </ul>
          </div>
        </div>
